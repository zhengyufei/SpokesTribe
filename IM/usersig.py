...
MHQCAQEEIMZE68db6fWYnXq4e9kb0yFm6YEkAy/wd182qqlM5f9DoAcGBSuBBAAK
oUQDQgAErCDeMJ7SzsatX5nkk5Y1eRkRykO2PSSjvhmUxRNtr6rM37gd5kaSuRSF
nLXcsXsiOli2MVUDojdWC6blVmLMpA==
-----END EC PRIVATE KEY-----
"""
...
class TLSSigAPI:
    ...
    def tls_gen_sig(self, identifier):
        ...
        m["TLS.sig"] = str(sig_field_base64,'utf-8')
...
def sig(im_account):
    api = TLSSigAPI(1400021429, ecdsa_pri_key)
    sig = api.tls_gen_sig(im_account)
    return str(sig,'utf-8')

def admin():
    return sig('zhengyufei')